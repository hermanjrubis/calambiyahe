...
window.translations = {
    en: {
        ...
        'faq3.q':               'Does the website show exact fares?',
        'faq3.a':               'The platform provides estimated fares based on available data. Actual fares may vary slightly depending on operator policies.',
        'faq4.q':               'Can I access Calzada on mobile devices?',
        'faq4.a':               'Yes. The website is built with a responsive design that adjusts to different screen sizes — desktop, laptop, or smartphone.',
        'faq5.q':               'What transport modes are included?',
        'faq5.a':               'Currently, Calzada supports jeepneys, buses, P2P, UV Express, and tricycles — the most common commuting options in Calamba and nearby areas.',
        'faq6.q':               'Is Calzada free to use?',
        'faq6.a':               'Yes. The platform is completely free for commuters and does not require any subscription.',
        'faq7.q':               'What is the main goal of Calzada?',
        'faq7.a':               'The primary goal is to empower commuters with accurate, transparent, and easy-to-use transit information — reducing commuting stress and improving mobility in the city.',
        // === places.html ===
